    ...
    data: [
      {
        ...
        price: "899.00" as any,
        installmentCount: 12,
        installmentAmount: (899 / 12).toFixed(2) as any,
        brand: "Samsung",
        rating: 4.6,
      ...
      },
      {
        ...
        installmentCount: 12,
        installmentAmount: (1199 / 12).toFixed(2) as any,
        brand: "Whirlpool",
        rating: 4.3,
      ...
      },
      {
        ...
        price: "679.00" as any,
        installmentCount: 12,
        installmentAmount: (679 / 12).toFixed(2) as any,
        brand: "LG",
        rating: 4.4,
      ...
      },
      {
        ...
        price: "499.00" as any,
        installmentCount: 12,
        installmentAmount: (499 / 12).toFixed(2) as any,
        brand: "TCL",
        rating: 4.5,
