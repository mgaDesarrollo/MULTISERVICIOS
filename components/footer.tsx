          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-6 group">
                ...
                <span className="ml-3 text-2xl font-bold bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 bg-clip-text text-transparent">MULTISERVICIOS</span>
              </div>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-semibold text-lg mb-6 bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent">Enlaces Rápidos</h3>
            ...
            {/* Contact Info */}
            <div>
              <h3 className="font-semibold text-lg mb-6 bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent">Contacto</h3>
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div className="text-neutral-400">info@multiservicios.com</div>
                </li>
              </ul>
            </div>
          </div>
